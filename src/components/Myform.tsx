...
// Defines the shape of your form data in TypeScript.

// Ensures that the form values match this type.
...
// Creates a form state manager for these specific fields.

// register → connects an input to the form.

// handleSubmit → runs your onSubmit function with form data.
